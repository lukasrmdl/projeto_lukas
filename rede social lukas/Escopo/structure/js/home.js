		...
		success: function(res) {
			...
			if (posts.length == 0) {
				...
				for (i=0; i<posts.length; i++) {
					...
					html += "<div class='feed'><div class='feed_inf'><span class='name'>"+posts[i].first_name+" "+posts[i].last_name+"</span></div><p class='feed_text'>"+posts[i].text+"</p><div class='lasticon'><span class='likes'>"+posts[i].likes+"</span><span class='"+src+"' data-post-id='"+ posts[i].post_id + "''></span></div></div>";
				}
			}
			wrapper.html(html);
		}
